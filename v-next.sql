...
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(b)(1)(i)(B)' and name LIKE 'Optional: 170.314(b)(1)(i)(B) Receive summary care record using the standards specified at %';
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(b)(1)(i)(C)' and name LIKE 'Optional: 170.314(b)(1)(i)(C) Receive summary care record using the standards specified at %';
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(f)(3)(i)(B)' and name LIKE 'Optional: 170.314(f)(3)(i)(B) Create syndrome-based public health surveillance information for transmission using the standard specified at %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(a)(5)(i)' and name LIKE 'Ambulatory setting: 170.314(a)(5)(i) Over multiple encounters in accordance with, at a minimum, the version of the standard specified in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(f)(3)(i)' and name LIKE 'Ambulatory setting: 170.314(f)(3)(i) (A) The standard specified in %';
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(a)(5)(ii)' and name LIKE 'Inpatient setting: 170.314(a)(5)(ii) For the duration of an entire hospitalization in accordance with, at a minimum, the version of the standard specified in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(e)(1)(i)(C)(2)' and name LIKE 'Inpatient setting: 170.314(e)(1)(i)(C)(2) Electronically transmit transition of care/referral summaries (as a result of a transition of care/referral) selected by the patient (or their authorized representative) in accordance with at least one of the following: (i) The standard specified in %';
UPDATE openchpl.test_functionality SET certification_edition_id = 2 WHERE number = '(f)(3)(ii)' and name LIKE 'Inpatient setting: 170.314(f)(3)(ii)  The standard (and applicable implementation specifications) specified in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '(d)(9)(i)' and name LIKE 'Alternative: 170.315(d)(9)(i) Message-level. Encrypt and integrity protect message contents in accordance with the standards specified in %';
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '(d)(9)(ii)' and name LIKE 'Alternative: 170.315(d)(9)(ii) Transport-level. Use a trusted connection in accordance with the standards specified in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '(a)(13)(ii)' and name LIKE 'Optional: 170.315(a)(13)(ii) Request that patient-specific education resources be identified in accordance with the standard in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '170.102(19)(i)' and name LIKE 'Optional: Common Clinical Data Set 170.102(19)(i) For certification to the 2015 Edition health IT certification criteria in accordance with the "Assessment and Plan Section (V2)" of the standard specified in %';
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '170.102(19)(ii)' and name LIKE 'Optional: Common Clincial Data Set 170.102(19)(ii)  For certification to the 2015 Edition health IT certification criteria in accordance with the "Assessment Section (V2)" and "Plan of Treatment Section (V2)" of the standard specified in %';
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '(a)(6)(i)' and name LIKE 'Ambulatory: 170.315(a)(6)(i) Over multiple encounters in accordance with, at a minimum, the version of the standard specified in %';
...
UPDATE openchpl.test_functionality SET certification_edition_id = 3 WHERE number = '(a)(6)(ii)' and name LIKE 'Inpatient: 170.315(a)(6)(ii) For the duration of an entire hospitalization in accordance with, at a minimum, the version of the standard specified in %';
