...
/* DROP INDEXES SCRIPT:
DROP INDEX IF EXISTS openchpl.ix_certified_product;
DROP INDEX IF EXISTS openchpl.ix_product;
DROP INDEX IF EXISTS openchpl.ix_vendor;
DROP INDEX IF EXISTS openchpl.ix_certification_criterion;
DROP INDEX IF EXISTS openchpl.ix_certification_event;
DROP INDEX IF EXISTS openchpl.ix_certification_result;
DROP INDEX IF EXISTS openchpl.ix_certification_result_additional_software;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_data;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_functionality;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_procedure;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_standard;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_task;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_task_participant;
DROP INDEX IF EXISTS openchpl.ix_certification_result_test_tool;
DROP INDEX IF EXISTS openchpl.ix_certification_result_ucd_process;
DROP INDEX IF EXISTS openchpl.ix_certified_product_qms_standard;
DROP INDEX IF EXISTS openchpl.ix_pending_certified_product;
DROP INDEX IF EXISTS openchpl.ix_contact;
DROP INDEX IF EXISTS openchpl.ix_cqm_criterion;
DROP INDEX IF EXISTS openchpl.ix_cqm_result;
DROP INDEX IF EXISTS openchpl.ix_ehr_certification_id;
DROP INDEX IF EXISTS openchpl.ix_ehr_certification_id_product_map;
DROP INDEX IF EXISTS openchpl.ix_global_user_permission_map;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_additional_software;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_data;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_functionality;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_procedure;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_standard;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_task;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_task_participant;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_test_tool;
DROP INDEX IF EXISTS openchpl.ix_pending_certification_result_ucd_process;
DROP INDEX IF EXISTS openchpl.ix_pending_certified_product;
DROP INDEX IF EXISTS openchpl.ix_pending_certified_product_accessibility_standard;
DROP INDEX IF EXISTS openchpl.ix_pending_certified_product_qms_standard;
DROP INDEX IF EXISTS openchpl.ix_pending_cqm_certification_criteria;
DROP INDEX IF EXISTS openchpl.ix_pending_cqm_criterion;
DROP INDEX IF EXISTS openchpl.ix_pending_test_participant;
DROP INDEX IF EXISTS openchpl.ix_pending_test_task;
DROP INDEX IF EXISTS openchpl.ix_product_version;
DROP INDEX IF EXISTS openchpl.ix_surveillance;
DROP INDEX IF EXISTS openchpl.ix_surveillance_nonconformity;
DROP INDEX IF EXISTS openchpl.ix_surveillance_requirement;
DROP INDEX IF EXISTS openchpl.ix_surveillance_requirement_type;
DROP INDEX IF EXISTS openchpl.ix_test_functionality;
DROP INDEX IF EXISTS openchpl.ix_test_participant;
DROP INDEX IF EXISTS openchpl.ix_test_procedure;
DROP INDEX IF EXISTS openchpl.ix_test_standard;
*/
