...
SELECT (SELECT certification_criterion_id from openchpl.certification_criterion where number = '170.315 (a)(1)'),
	'GAP-EP',
...
WHERE NOT EXISTS (
    SELECT * 
	FROM openchpl.macra_criteria_map
	WHERE value = 'GAP-EH/CAH'
	AND name = '(Gap Certified) Computerized Provider Order Entry - Medications: Eligible Hospital/Critical Access Hospital'
	AND description = 'Required Test 10: Stage 2 Objective 3 Measure 1 and Stage 3 Objective 4 Measure 1'
	AND last_modified_user = -1
);
INSERT INTO openchpl.macra_criteria_map (criteria_id, value, name, description, last_modified_user)
SELECT (SELECT certification_criterion_id from openchpl.certification_criterion where number = '170.315 (a)(2)'),
	'GAP-EP',
...
INSERT INTO openchpl.macra_criteria_map (criteria_id, value, name, description, last_modified_user)
SELECT (SELECT certification_criterion_id from openchpl.certification_criterion where number = '170.315 (a)(3)'),
	'GAP-EP',
