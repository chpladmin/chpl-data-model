...
insert into openchpl.notification_type_recipient_map (recipient_id, notification_type_id, last_modified_user) values
	...
	,((select id from openchpl.notification_recipient where email = 'amore@ainq.com' and deleted = false), (select id from openchpl.notification_type where "name" = 'Weekly Statistics'), -2)
;
