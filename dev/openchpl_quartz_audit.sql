...
--this one creates an entry every couple seconds to update the "last checkin time"
--CREATE TRIGGER qrtz_scheduler_state_audit AFTER INSERT OR UPDATE OR DELETE on quartz.QRTZ_SCHEDULER_STATE FOR EACH ROW EXECUTE PROCEDURE audit.if_modified_func();
