...
CREATE TABLE openchpl.pending_test_participant (
	...
	professional_experience_months varchar(25),
	computer_experience_months varchar(25),
	product_experience_months varchar(25),
...
CREATE TABLE openchpl.pending_test_task (
	...
	description text,
	task_success_avg_pct varchar(25),
	task_success_stddev_pct varchar(25),
	task_path_deviation_observed varchar(25),
	task_path_deviation_optimal varchar(25),
	task_time_avg_seconds varchar(25),
	task_time_stddev_seconds varchar(25),
	task_time_deviation_observed_avg_seconds varchar(25),
	task_time_deviation_optimal_avg_seconds varchar(25),
	task_errors_pct varchar(25),
	task_errors_stddev_pct varchar(25),
	task_rating_scale varchar(50),
	task_rating varchar(25),
	task_rating_stddev varchar(25),
	creation_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_user bigint NOT NULL,
	deleted bool NOT NULL DEFAULT false,
