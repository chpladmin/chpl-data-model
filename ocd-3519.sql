...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC'), 'RT2a ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Clinician', 'Required Test 2: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC'), 'RT2b ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Clinician', 'Required Test 2: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT2a ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT2b ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicare and Medicaid PI'), 'RT2a ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Hospital/Critical Access Hospital', 'Required Test 2: Medicare and Medicaid Promoting Interoperability Programs', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicaid PI'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT2a ', 'Patient Electronic Access: Eligible Clinician Group', 'Required Test 2: Stage 2 Objective 8 Measure 1 and Stage 3 Objective 5 Measure 1, ACI Transition Objective 3 Measure 1 and ACI Objective 3 Measure 1', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicaid PI'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC'), 'RT2c ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Clinician', 'Required Test 2: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT2a ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Hospital/Critical Access Hospital', 'Required Test 2: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Clinician Group', 'Required Test 4: Stage 2 Objective 8 Measure 2 and Stage 3 Objective 6 Measure 1, ACI Transition Objective 3 Measure 2 and ACI Objective 4 Measure 1', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT2c ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT2c ', 'Patient Electronic Access: Eligible Clinician Group', 'Required Test 2: Stage 2 Objective 8 Measure 1 and Stage 3 Objective 5 Measure 1, ACI Transition Objective 3 Measure 1 and ACI Objective 3 Measure 1', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Clinician Group', 'Required Test 4: Stage 2 Objective 8 Measure 2 and Stage 3 Objective 6 Measure 1, ACI Transition Objective 3 Measure 2 and ACI Objective 4 Measure 1', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT4c ', 'View, Download, or Transmit (VDT): Eligible Clinician Group', 'Required Test 4: Stage 2 Objective 8 Measure 2 and Stage 3 Objective 6 Measure 1, ACI Transition Objective 3 Measure 2 and ACI Objective 4 Measure 1', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicare and Medicaid PI'), 'RT2c ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Hospital/Critical Access Hospital', 'Required Test 2: Medicare and Medicaid Promoting Interoperability Programs', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicaid PI'), 'RT4c ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT4c ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Medicare and Medicaid PI'), 'RT2b ', 'Provide Patients Electronic Access to Their Health Information (formerly Patient Electronic Access): Eligible Hospital/Critical Access Hospital', 'Required Test 2: Medicare and Medicaid Promoting Interoperability Programs', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Medicaid PI'), 'RT4c ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Medicaid Promoting Interoperability Program', true, false, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC Group'), 'RT2b ', 'Patient Electronic Access: Eligible Clinician Group', 'Required Test 2: Stage 2 Objective 8 Measure 1 and Stage 3 Objective 5 Measure 1, ACI Transition Objective 3 Measure 1 and ACI Objective 3 Measure 1', true, false, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Clinician', 'Required Test 4: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Clinician ', 'Required Test 4: Merit-based Incentive Payment System (MIPS) Promoting Interoperability Performance Category', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Stage 2 Objective 8 Measure 2', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT2a ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT4c ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Stage 2 Objective 8 Measure 2', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC ACI Transition'), 'RT2b ', 'Patient Electronic Access: Eligible Clinician', 'Required Test 2: Promoting Interoperability Transition Objective 3 Measure 1 ', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC ACI Transition'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Clinician', 'Required Test 4: Promoting Interoperability Transition Objective 3 Measure 2 ', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT2a ', 'Patient Electronic Access: Eligible Hospital/Critical Access Hospital', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT2b ', 'Patient Electronic Access: Eligible Hospital/Critical Access Hospital', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EC ACI Transition'), 'RT2a ', 'Patient Electronic Access: Eligible Clinician', 'Required Test 2: Promoting Interoperability Transition Objective 3 Measure 1', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT2c ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT4a ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Stage 2 Objective 8 Measure 2', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Hospital/Critical Access Hospital', 'Required Test 4: Stage 2 Objective 8 Measure 2', true, true, -1;
...
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT2c ', 'Patient Electronic Access:  Eligible Hospital/Critical Access Hospital', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EH/CAH Stage 2'), 'RT2c ', 'Patient Electronic Access: Eligible Hospital/Critical Access Hospital', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT2b ', 'Patient Electronic Access: Eligible Professional', 'Required Test 2: Stage 2 Objective 8 Measure 1', true, true, -1;
INSERT INTO openchpl.mips_measure (mips_domain_id, required_test_abbr, required_test, measure_name, criteria_selection_required, removed, last_modified_user) SELECT (SELECT id FROM openchpl.mips_domain WHERE domain = 'EP Stage 2'), 'RT4b ', 'View, Download, or Transmit (VDT): Eligible Professional', 'Required Test 4: Stage 2 Objective 8 Measure 2', true, true, -1;
