...
-- test with product 7706 on DEV and 7733 on STGALTER TABLE openchpl.test_task ADD COLUMN task_rating_stddev float;
    ALTER TABLE openchpl.pending_test_task ADD COLUMN task_rating_stddev float;
