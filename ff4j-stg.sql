insert into ff4j.features (feat_uid, enable, description, strategy, expression) values
    ...
    ('role-developer', 0, 'Enable creation / log-in of users with "ROLE_DEVELOPER" abilities', null, null),
    ('complaints', 1, 'Enable ONC-ACB Users to record and store "Complaints" from the public', null, null),
    ('change-request', 0, 'Allow ROLE_DEVELOPER Users to submit "Change Requests"', null, null),
    ...
    ('effective-rule-date', 0, 'Features that should be enabled/disabled on the date the Rule becomes effective', 'org.ff4j.strategy.time.ReleaseDateFlipStrategy', 'releaseDate=2020-06-14-14:00'),
    ('effective-rule-date+1-week', 0, 'Features that should be enabled/disabled one week after the date the rule becomes effective', 'org.ff4j.strategy.time.ReleaseDateFlipStrategy', 'releaseDate=2020-06-21-14:00')
;
