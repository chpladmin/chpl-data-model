...
ALTER INDEX openchpl.test_procedure_temp_pk RENAME TO test_procedure_pk;
ALTER TABLE openchpl.test_procedure_temp RENAME TO test_procedure;

ALTER INDEX openchpl.test_procedure_criteria_map_temp_pk RENAME TO test_procedure_criteria_map_pk;
ALTER TABLE openchpl.test_procedure_criteria_map_temp DROP CONSTRAINT IF EXISTS test_procedure_temp_fk;
ALTER TABLE openchpl.test_procedure_criteria_map_temp DROP CONSTRAINT IF EXISTS test_procedure_fk;
ALTER TABLE openchpl.test_procedure_criteria_map_temp ADD CONSTRAINT 
	test_procedure_fk FOREIGN KEY (test_procedure_id) 
	REFERENCES openchpl.test_procedure (id) 
	MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE openchpl.test_procedure_criteria_map_temp RENAME TO test_procedure_criteria_map;


ALTER INDEX openchpl.certification_result_test_procedure_temp_pk RENAME TO certification_result_test_procedure_pk;
ALTER TABLE openchpl.certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS test_procedure_temp_fk;
ALTER TABLE openchpl.certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS test_procedure_fk;
ALTER TABLE openchpl.certification_result_test_procedure_temp ADD CONSTRAINT 
	test_procedure_fk FOREIGN KEY (test_procedure_id) 
	REFERENCES openchpl.test_procedure (id) 
	MATCH FULL ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE openchpl.certification_result_test_procedure_temp RENAME TO certification_result_test_procedure;

ALTER INDEX openchpl.pending_certification_result_test_procedure_temp_pk RENAME TO pending_certification_result_test_procedure_pk;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS pending_certification_result_temp_fk;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS pending_certification_result_fk;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp ADD CONSTRAINT
...
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS test_procedure_temp_fk;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp DROP CONSTRAINT IF EXISTS test_procedure_fk;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp ADD CONSTRAINT
	test_procedure_fk FOREIGN KEY (test_procedure_id)
	REFERENCES openchpl.test_procedure (id) MATCH FULL
	ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE openchpl.pending_certification_result_test_procedure_temp RENAME TO pending_certification_result_test_procedure;
