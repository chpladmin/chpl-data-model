...
(
    ...
    surveillance_id varchar(64) NOT NULL,
    date_surveillance_began varchar(64) NOT NULL,
    date_surveillance_ended varchar(64),
    surveillance_type varchar(64) NOT NULL,
    ...
    number_of_days_from_determination_to_cap_approval int,
    number_of_days_from_determination_to_present int,
    number_of_days_from_cap_approval_to_cap_began int,
    number_of_days_from_cap_approval_to_present int,
    number_of_days_from_cap_began_to_cap_completed int,
    number_of_days_from_cap_began_to_present int,
    difference_from_cap_completed_and_cap_must_be_completed int,
