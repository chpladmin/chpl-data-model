...
SELECT add_version_to_cqm('CMS2', 'v12', 'v11');
SELECT add_version_to_cqm('CMS2', 'v12', 'v11');
SELECT add_version_to_cqm('CMS22', 'v11', 'v10');
SELECT add_version_to_cqm('CMS50', 'v11', 'v10');
SELECT add_version_to_cqm('CMS56', 'v11', 'v10');
SELECT add_version_to_cqm('CMS66', 'v11', 'v10');
SELECT add_version_to_cqm('CMS68', 'v12', 'v11');
SELECT add_version_to_cqm('CMS69', 'v11', 'v10');
SELECT add_version_to_cqm('CMS74', 'v12', 'v11');
SELECT add_version_to_cqm('CMS75', 'v11', 'v10');
SELECT add_version_to_cqm('CMS90', 'v12', 'v11');
SELECT add_version_to_cqm('CMS117', 'v11', 'v10');
SELECT add_version_to_cqm('CMS122', 'v11', 'v10');
SELECT add_version_to_cqm('CMS124', 'v11', 'v10');
SELECT add_version_to_cqm('CMS125', 'v11', 'v10');
SELECT add_version_to_cqm('CMS127', 'v11', 'v10');
SELECT add_version_to_cqm('CMS128', 'v11', 'v10');
SELECT add_version_to_cqm('CMS129', 'v12', 'v11');
SELECT add_version_to_cqm('CMS130', 'v11', 'v10');
SELECT add_version_to_cqm('CMS131', 'v11', 'v10');
SELECT add_version_to_cqm('CMS133', 'v11', 'v10');
SELECT add_version_to_cqm('CMS134', 'v11', 'v10');
SELECT add_version_to_cqm('CMS135', 'v11', 'v10');
SELECT add_version_to_cqm('CMS136', 'v12', 'v11');
SELECT add_version_to_cqm('CMS137', 'v11', 'v10');
SELECT add_version_to_cqm('CMS138', 'v11', 'v10');
SELECT add_version_to_cqm('CMS139', 'v11', 'v10');
SELECT add_version_to_cqm('CMS142', 'v11', 'v10');
SELECT add_version_to_cqm('CMS143', 'v11', 'v10');
SELECT add_version_to_cqm('CMS144', 'v11', 'v10');
SELECT add_version_to_cqm('CMS145', 'v11', 'v10');
SELECT add_version_to_cqm('CMS146', 'v11', 'v10');
SELECT add_version_to_cqm('CMS147', 'v12', 'v11');
SELECT add_version_to_cqm('CMS149', 'v11', 'v10');
SELECT add_version_to_cqm('CMS153', 'v11', 'v10');
SELECT add_version_to_cqm('CMS154', 'v11', 'v10');
SELECT add_version_to_cqm('CMS155', 'v11', 'v10');
SELECT add_version_to_cqm('CMS156', 'v11', 'v10');
SELECT add_version_to_cqm('CMS157', 'v11', 'v10');
SELECT add_version_to_cqm('CMS159', 'v11', 'v10');
SELECT add_version_to_cqm('CMS161', 'v11', 'v10');
SELECT add_version_to_cqm('CMS165', 'v11', 'v10');
SELECT add_version_to_cqm('CMS177', 'v11', 'v10');
SELECT add_version_to_cqm('CMS249', 'v5', 'v4');
SELECT add_version_to_cqm('CMS347', 'v6', 'v5');
SELECT add_version_to_cqm('CMS349', 'v5', 'v4');
SELECT add_version_to_cqm('CMS645', 'v6', 'v5');
SELECT add_version_to_cqm('CMS646', 'v3', 'v2');
SELECT add_version_to_cqm('CMS771', 'v4', 'v3');
SELECT add_version_to_cqm('CMS9', 'v11', 'v10');
SELECT add_version_to_cqm('CMS71', 'v12', 'v11');
SELECT add_version_to_cqm('CMS72', 'v11', 'v10');
SELECT add_version_to_cqm('CMS104', 'v11', 'v10');
SELECT add_version_to_cqm('CMS105', 'v11', 'v10');
SELECT add_version_to_cqm('CMS108', 'v11', 'v10');
SELECT add_version_to_cqm('CMS111', 'v11', 'v10');
SELECT add_version_to_cqm('CMS190', 'v11', 'v10');
SELECT add_version_to_cqm('CMS506', 'v5', 'v4');
SELECT add_version_to_cqm('CMS529', 'v3', 'v2');
SELECT add_version_to_cqm('CMS844', 'v3', 'v2');
