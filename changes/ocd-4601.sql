...
\copy (select distinct cpd.certification_body_name, cpd.vendor_name as developer_name, cpd.product_name, cpd.certification_status_name, 'https://chpl.healthit.gov/#/listing/'||cpd.certified_product_id as link_in_chpl from openchpl.certified_product_details cpd join openchpl.certification_result cr on cpd.certified_product_id = cr.certified_product_id and cr.success = true and cr.deleted = false join openchpl.certification_result_functionality_tested crft on crft.certification_result_id = cr.certification_result_id and crft.deleted = false where cr.success = true and cr.certification_criterion_id = 35 and crft.functionality_tested_id = 41 and cpd.deleted = false) to d7_with_d7ii.csv with csv header

\echo 'active certificates that attested to d7 and did not use functionality tested d7ii - pre'
\copy (select distinct cpd.certification_body_name, cpd.vendor_name as developer_name, cpd.product_name, cpd.certification_status_name, 'https://chpl.healthit.gov/#/listing/'||cpd.certified_product_id as link_in_chpl from openchpl.certified_product_details cpd join openchpl.certification_result cr on cpd.certified_product_id = cr.certified_product_id and cr.success = true and cr.deleted = false join openchpl.certification_result_functionality_tested crft on crft.certification_result_id = cr.certification_result_id and crft.deleted = false where cr.success = true and cr.certification_criterion_id = 35 and crft.functionality_tested_id <> 41 and cpd.deleted = false) to d7_without_d7ii.csv with csv header

\echo 'active certificates that attested to d12 and had "Attestation" as "No" - pre'
\copy (select distinct cpd.certification_body_name, cpd.vendor_name as developer_name, cpd.product_name, cpd.certification_status_name, 'https://chpl.healthit.gov/#/listing/'||cpd.certified_product_id as link_in_chpl from openchpl.certified_product_details cpd join openchpl.certification_result cr on cpd.certified_product_id = cr.certified_product_id and cr.success = true and cr.deleted = false where cr.success = true and cr.certification_criterion_id = 176 and cr.attestation_answer = 'No' and cpd.deleted = false) to d12_with_attestation_yes.csv with csv header

\echo 'active certificates that attested to d12 and had "Attestation" as "Yes" - pre'
\copy (select distinct cpd.certification_body_name, cpd.vendor_name as developer_name, cpd.product_name, cpd.certification_status_name, 'https://chpl.healthit.gov/#/listing/'||cpd.certified_product_id as link_in_chpl from openchpl.certified_product_details cpd join openchpl.certification_result cr on cpd.certified_product_id = cr.certified_product_id and cr.success = true and cr.deleted = false where cr.success = true and cr.certification_criterion_id = 176 and cr.attestation_answer = 'Yes' and cpd.deleted = false) to d12_with_attestation_no.csv with csv header
