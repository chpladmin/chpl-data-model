...
select 'DEV', 
        'Service Base URL Listing Report',
        'ServiceBaseUrlListingReport', 
        'dashboard', 
        ...
        -1
where not exists (
        select * from openchpl.report_metadata where environment = 'DEV' and report_key = 'ServiceBaseUrlListingReport'
);
...
select 'QA', 
        ...
        -1
where not exists (
        select * from openchpl.report_metadata where environment = 'QA' and report_key = 'ServiceBaseUrlListingReport'
);
...
select 'STG', 
        ...
        -1
where not exists (
        select * from openchpl.report_metadata where environment = 'STG' and report_key = 'ServiceBaseUrlListingReport'
);
...
select 'PROD', 
        ...
        -1
where not exists (
        select * from openchpl.report_metadata where environment = 'PROD' and report_key = 'ServiceBaseUrlListingReport'
);
