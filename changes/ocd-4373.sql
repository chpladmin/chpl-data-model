...
call openchpl.backfill_standards('170.205(a)(6)', 'HL7® CDA R2 Implementation Guide: C-CDA Templates for Clinical Notes R2.1 Companion Guide, Release 4-US Realm, May 2023', 5, '2024-03-11', '2025-12-31', null, 'CCDA-CG', null, array[165, 166, 170, 178, 180, 181]);
...
call openchpl.backfill_standards('170.205(t)(3)', 'HL7 CDA® R2 Implementation Guide: Reportability Response, Release 1, STU Release 1.1—US Realm (HL7 CDA RR IG)', 5, '2024-03-11', '2025-12-31', null, 'F5-group-1', 'For receiving, consuming and processing a case report, must certify to HL7 FHIR eCR IG in § 170.205(t)(1) or the HL7 CDA RR IG in § 170.205(t)(3) as dependent on standard selected in paragraph 170.215(f)(5)(ii)(B).', array[179]);

call openchpl.backfill_standards('170.205(t)(4)', 'Reportable Conditions Trigger Codes Value Set for Electronic Case Reporting. RCTC OID: 2.16.840.1.114222.4.11.7508, Release March 29, 2022', 5, '2024-03-11', '2025-12-31', null, 'F5-group-1', 'Must certify to the Reportable Conditions Trigger Codes Cvalue Set for eCR.', array[179]);
...
call openchpl.backfill_standards('170.213(b)', 'United States Core Data for Interoperability (USCDI), October 2022 Errata, Version 3', 5, '2024-03-11', '2025-12-31', null, 'USCDI', null, array[165, 166, 178, 179, 180, 181, 182, 210]);
...
call openchpl.backfill_standards('170.215(b)(1)(ii)', 'HL7 FHIR® US Core Implementation Guide STU 6.1.0', 5, '2024-03-11', '2025-12-31', null, 'US Core', null, array[182]);

call openchpl.backfill_standards('170.215(c)(2)', 'HL7 SMART Application Launch Framework Implementation Guide Release 2.0.0', 5, '2024-03-11', '2025-12-31', null, 'SMART', null, array[182]);
...
call openchpl.backfill_standards('170.205(t)(1)', 'HL7 FHIR® Implementation Guide: Electronic Case Reporting (eCR)—US Realm 2.1.0—STU 2 US (HL7 FHIR eCR IG)', 5, '2024-03-11', '2025-12-31', null, 'F5-group-1', 'For creating a case report, must certify to the eICR profile of the HL7 FHIR eCR IG in § 170.205(t)(1) or (2) The HL7 CDA eICR IG in § 170.205(t)(2). If certifiying to the HL7 FHIR eCR IG for case report creation, must also certify to this standard for report receipt, consumption and processing.', array[179]);

call openchpl.backfill_standards('170.205(t)(2)', 'HL7 CDA® R2 Implementation Guide: Public Health Case Report—the Electronic Initial Case Report (eICR) Release 2, STU Release 3.1—US Realm (HL7 CDA eICR IG)', 5, '2024-03-11', '2025-12-31', null, 'F5-group-1', 'For creating a case report, must certify to the eICR profile of the HL7 FHIR eCR IG in § 170.205(t)(1) or (2) The HL7 CDA eICR IG in § 170.205(t)(2). If certifiying to the HL7 CDA eICR IG for case report creation, must also certify to HL7 CDA RR IG in § 170.205(t)(3) for report receipt, consumption and processing.', array[179]);
