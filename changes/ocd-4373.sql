...
call openchpl.backfill_standards('170.213(a)', 'United States Core Data for Interoperability (USCDI), July 2020 Errata, Version 1', 4, '2020-06-30', '2022-12-31', '2025-12-31', 'USCDI', 'Must be replaced by United States Core Data for Interoperability (USCDI), October 2022 Errata, Version 3', array[47, 165, 166, 178, 47, 180, 182]);

call openchpl.backfill_standards('170.213(a)', 'United States Core Data for Interoperability (USCDI), July 2020 Errata, Version 1', 4, '2020-06-30', '2022-12-31', '2025-12-31', 'USCDI', 'Must be replaced by United States Core Data for Interoperability (USCDI), October 2022 Errata, Version 3', array[181]);

call openchpl.backfill_standards('170.213(b)', 'United States Core Data for Interoperability (USCDI), October 2022 Errata, Version 3', 5, '2024-02-11', '2025-12-31', null, 'USCDI', null, array[47, 165, 166, 178, 180, 181, 182]);
...
call openchpl.backfill_standards('170.215(b)(1)(ii)', 'HL7 FHIR® US Core Implementation Guide STU 6.1.0', 5, '2024-02-11', '2025-12-31', null, 'US Core', null, array[182]);
