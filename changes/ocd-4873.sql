...
SELECT 'Listing Service Base URL List Change Request', '6498c4f8-b0f1-70b5-55de-d84faae73402'
WHERE NOT EXISTS (SELECT * FROM openchpl.change_request_type WHERE name = 'Listing Service Base URL List Change Request');
