insert into ff4j.features (feat_uid, enable, description, strategy, expression) values
    ...
    ('states', 1, 'Show AngularJS state transitions. Useful for debugging', null, null),
    ...
    ('effective-rule-date', 1, 'Features that should be enabled/disabled on the date the Rule becomes effective', 'org.ff4j.strategy.time.ReleaseDateFlipStrategy', 'releaseDate=2019-10-22-14:00'),
    ('effective-rule-date+1-week', 1, 'Features that should be enabled/disabled one week after the date the rule becomes effective', 'org.ff4j.strategy.time.ReleaseDateFlipStrategy', 'releaseDate=2019-10-29-14:00')
;
