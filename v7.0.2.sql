...
CREATE TEMP TABLE surveillance_nonconformity_temp AS
	...
	c.start_date AS corrective_action_start_date, 
	...
	CASE WHEN cr.developer_explanation IS NOT NULL THEN cr.developer_explanation WHEN c.developer_explanation IS NOT NULL THEN c.developer_explanation ELSE NULL END AS developer_explanation, 
	CASE WHEN cr.resolution IS NOT NULL THEN cr.resolution WHEN c.resolution IS NOT NULL THEN c.resolution ELSE NULL END AS resolution, 
	r.creation_date, 
