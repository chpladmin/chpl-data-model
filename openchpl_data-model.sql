...
CREATE TABLE openchpl.certification_result(
	...
	gap bool default null,
	sed bool default null,
	g1_success bool default null,
	g2_success bool default null,
	ucd_process_selected text default null,
	ucd_process_details text default null,
	creation_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_user bigint NOT NULL,
	deleted bool NOT NULL DEFAULT false,
...
CREATE TABLE openchpl.pending_certification_result_test_standard (
	...
	test_standard_id bigint,
	test_standard_name varchar(200),
	creation_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_user bigint NOT NULL,
	deleted bool NOT NULL,
...
(
	...
	test_functionality_name varchar(200),
	test_functionality_category varchar(200),
	creation_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_date timestamp NOT NULL DEFAULT NOW(),
	last_modified_user bigint NOT NULL,
	deleted bool NOT NULL,
