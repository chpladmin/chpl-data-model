-- View: openchpl.acb_vendor_transparency_mappings

-- DROP VIEW openchpl.acb_vendor_transparency_mappings;

CREATE OR REPLACE VIEW openchpl.acb_vendor_transparency_mappings AS
...
--ALTER TABLE openchpl.acb_vendor_transparency_mappings OWNER TO openchpl;
